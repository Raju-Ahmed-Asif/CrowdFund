...
@section('content')
 ...
 <main>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cases mb-40">
                        <div class="cases-img">
                           <a href="{{route('crisis.details',$item->id)}}"><img src="{{asset('/public/uploads/'.$item->image)}}" alt="image"></a>
                        </div>
    ...
    <!-- Blog Area End -->
    <!--? Count Down Start -->
    <div class="count-down-area pt-25 section-bg" data-background="{{asset ('frontend/assets/img/gallery/section_bg02.png') }}">
        <div class="container">
            <div class="row justify-content-center">
